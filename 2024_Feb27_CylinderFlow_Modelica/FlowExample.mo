package FlowExample
  model VelocityField
    ...
    Modelica.Mechanics.MultiBody.Visualizers.Advanced.Shape shape(height = Cylinder_Radius, length = 10*Cylinder_Radius, lengthDirection = {0, 0, -1}, shapeType = "cylinder", width = Cylinder_Radius) annotation(
      Placement(visible = true, transformation(origin = {-4, 18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    R = Cylinder_Radius;
    annotation(
      defaultComponentName = "velocityField",
  ...
  model Flow
    //
    outer FlowExample.VelocityField velocityfield;
  ...
  equation
    V_r = U*(1 - velocityfield.R^2/r^2)*cos(theta);
    der(r) = V_r;
//
    V_theta = -U*(1 + velocityfield.R^2/r^2)*sin(theta);
    der(theta) = V_theta/r;
//
    x = r*cos(theta);
    y = r*sin(theta);
//
  ...
  inner FlowExample.VelocityField velocityField annotation(
      Placement(visible = true, transformation(origin = {0, 0}, extent = {{-52, -52}, {52, 52}}, rotation = 0)));
  FlowExample.Flow flow1(r(fixed = true), theta(fixed = true), y_init = 0.05)  annotation(
      Placement(visible = true, transformation(origin = {-70, 30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FlowExample.Flow flow2(r(fixed = true), theta(fixed = true), y_init = 0.1) annotation(
      Placement(visible = true, transformation(origin = {-70, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FlowExample.Flow flow3(r(fixed = true), theta(fixed = true), y_init = 0.01) annotation(
      Placement(visible = true, transformation(origin = {-70, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FlowExample.Flow flow4(r(fixed = true), theta(fixed = true), y_init = -0.01) annotation(
      Placement(visible = true, transformation(origin = {-70, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FlowExample.Flow flow5(r(fixed = true), theta(fixed = true), y_init = -0.05) annotation(
      Placement(visible = true, transformation(origin = {-70, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FlowExample.Flow flow6(r(fixed = true), theta(fixed = true), y_init = -0.1) annotation(
      Placement(visible = true, transformation(origin = {-70, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FlowExample.Flow flow7(r(fixed = true), theta(fixed = true), y_init = -1) annotation(
      Placement(visible = true, transformation(origin = {-70, -70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  FlowExample.Flow flow8(r(fixed = true), theta(fixed = true), y_init = 1) annotation(
      Placement(visible = true, transformation(origin = {-70, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    annotation(
  ...
  model Test
  inner VelocityField velocityField annotation(
